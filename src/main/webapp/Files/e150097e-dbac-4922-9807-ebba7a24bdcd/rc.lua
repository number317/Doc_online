...
mylauncher = awful.widget.launcher({ image = "/home/cheon/.config/awesome/archlinux-artwork-1.6/wmlogos/archlinux-wm-awesome.svg",
                                     menu = mymainmenu })
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Control" }, "e", function() awful.util.spawn("thunderbird") end),
    awful.key({ modkey, "Control" }, "c", function() awful.util.spawn("galculator") end),
    awful.key({ modkey, "Control" }, "p", function () awful.util.spawn("scrot -e 'mv $f /home/cheon/Pictures/ 2>/dev/null'") end),
